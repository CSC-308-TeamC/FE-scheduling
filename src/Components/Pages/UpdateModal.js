...
function FormInject(props){
    if(props.formToInject === 1)
        return(<AppointmentForm updateObjectId={props.updateObjectId} clientNames={props.clientNames} dogNames={props.dogNames}
                                handleSubmit={props.updateFunction}/>);
    else if(props.formToInject === 2)
        return(<ClientForm updateObjectId={props.updateObjectId} handleSubmit={props.updateFunction}/>);
    else if(props.formToInject === 3)
        return(<DogForm updateObjectId={props.updateObjectId} clientNames={props.clientNames} handleSubmit={props.updateFunction}/>);
}
